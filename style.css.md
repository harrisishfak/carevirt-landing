...
/* ── Bloomy AI indicator in bar ── */
.vi-ai-pill {
  font-size: 0.5rem; font-weight: 800; letter-spacing: .07em;
...
.vi-ai-pill-dot {
  ...
  background: #7c3aed;
  animation: aiPillPulse 2s ease-in-out infinite;
}
@keyframes aiPillPulse {
  0%,100% { opacity: 1; }
  50%      { opacity: 0.4; }
}

/* ── Bloomy AI insight card in dashboard ── */
.vi-ai-insight {
  display: flex; align-items: flex-start; gap: 8px;
  margin-top: 7px; padding: 8px 10px;
  background: linear-gradient(135deg, rgba(124,58,237,.05), rgba(99,102,241,.05));
...
.vi-ai-label { font-size: 0.52rem; font-weight: 800; text-transform: uppercase; letter-spacing: .07em; color: #7c3aed; margin-bottom: 2px; }
.vi-ai-text  { font-size: 0.62rem; color: #64748b; line-height: 1.4; }
...
/* Status bar — iPhone 15/16/17 style */
.iph-sb {
  display: flex;
  align-items: center;
...
.iph-cam {
  ...
  box-shadow: inset 0 0 2px rgba(100,180,255,.2);
}
.iph-sb-icons {
  display: flex;
  align-items: center;
...
/* ── Session Form Screen ── */
.iph-row { cursor: default; transition: background .15s; }
.iph-row.row-live { cursor: pointer; }
.iph-row.row-live:hover { background: rgba(20,184,166,.08); }
...
.iph-form-screen.open {
  transform: translateX(0);
  visibility: visible;
}

/* form status bar — same style as main */
.iph-form-sb {
  background: #f2f2f7;
  border-bottom: none;
  padding-bottom: 2px;
...
.iph-back-btn {
  ...
  color: #007aff; font-size: 11px; font-weight: 500;
...
.iph-form-body::-webkit-scrollbar { display: none; }

.iph-form-patient {
  font-size: 9.5px; font-weight: 600; color: #14b8a6;
  background: rgba(20,184,166,.08);
...
.iph-textarea:focus, .iph-input:focus { border-color: #14b8a6; }
.iph-textarea { resize: none; min-height: 50px; }
...
.iph-file-label {
  ...
  font-size: 9px; color: #6e6e73; cursor: pointer;
  transition: border-color .15s, color .15s;
  box-sizing: border-box;
}
.iph-file-label:hover { border-color: #14b8a6; color: #14b8a6; }
...
.iph-submit-btn:active { opacity: .8; }
...
.iph-more-link:hover { text-decoration: underline; }
.iph-optional { color: #8e8e93; font-weight: 400; }
...
@media (max-width: 900px) {
  ...
  .mobile-visual-inner .vi-stage {
    transform: scale(0.62);
    transform-origin: top center;
    animation: none;
  }
  .mobile-visual-inner .vi-phone {
    animation: none;
  }
  .mobile-visual-inner .vi-badge {
    display: flex;
  }
}
.mhv-glow {
  ...
  background: radial-gradient(ellipse, rgba(20,184,166,.22) 0%, rgba(99,102,241,.12) 55%, transparent 75%);
  filter: blur(32px);
  pointer-events: none;
  z-index: 0;
}
...
.mhv-dots { display: flex; gap: 5px; }
.mhv-dots span { width: 8px; height: 8px; border-radius: 50%; background: #e2e8f0; }
.mhv-dots span:first-child  { background: #f87171; }
.mhv-dots span:nth-child(2) { background: #fbbf24; }
.mhv-dots span:nth-child(3) { background: #34d399; }
.mhv-title {
  font-size: 0.75rem;
  font-weight: 700;
  color: #0f172a;
...
.mhv-alert-green  { background: rgba(20,184,166,.08); color: #0d9488; }
.mhv-alert-orange { background: rgba(245,158,11,.08); color: #d97706; }
.mhv-alert-blue   { background: rgba(99,102,241,.08); color: #4f46e5; }
.mhv-sessions {
  display: flex;
  flex-direction: column;
  padding: 8px 0;
...
.mhv-row:not(:last-child) { border-bottom: 1px solid #f8fafc; }
.mhv-av {
...
.mhv-ri { flex: 1; display: flex; flex-direction: column; gap: 1px; }
.mhv-rname { font-size: 0.78rem; font-weight: 600; color: #0f172a; }
.mhv-rmeta { font-size: 0.68rem; color: #94a3b8; }
.mhv-tag { font-size: 0.62rem; font-weight: 700; padding: 3px 8px; border-radius: 20px; }
.mhv-done     { background: rgba(20,184,166,.1); color: #0d9488; }
.mhv-progress { background: rgba(99,102,241,.1); color: #6366f1; }
.mhv-pending  { background: rgba(245,158,11,.1); color: #d97706; }
.mhv-ack {
  display: flex;
  align-items: center;
  gap: 10px;
...
.mhv-ack-body { flex: 1; display: flex; flex-direction: column; gap: 1px; }
.mhv-ack-body strong { font-size: 0.75rem; color: #0f172a; }
.mhv-ack-body span   { font-size: 0.68rem; color: #64748b; }
.mhv-ack-time { font-size: 0.65rem; color: #14b8a6; font-weight: 700; white-space: nowrap; }
.mhv-badge {
  position: absolute;
  display: flex;
  align-items: center;
...
.mhv-badge-tl { top: -14px; left: 10px; animation-delay: 0s; }
.mhv-badge-br { bottom: 26px; right: 10px; animation-delay: 1.5s; }
...
.feat-card.fc-teal::after   { background: linear-gradient(90deg, #14b8a6, #0891b2); }
.feat-card.fc-blue::after   { background: linear-gradient(90deg, #6366f1, #8b5cf6); }
.feat-card.fc-purple::after { background: linear-gradient(90deg, #8b5cf6, #ec4899); }
.feat-card.fc-amber::after  { background: linear-gradient(90deg, #f59e0b, #f97316); }
.feat-card.fc-teal:hover  { border-color: rgba(20,184,166,.3); }
.feat-card.fc-blue:hover  { border-color: rgba(99,102,241,.3); }
.feat-card.fc-purple:hover{ border-color: rgba(139,92,246,.3); }
.feat-card.fc-amber:hover { border-color: rgba(245,158,11,.3); }
...
.feat-icon-teal   { background: rgba(20,184,166,.1);  color: #0d9488; box-shadow: 0 4px 14px rgba(20,184,166,.2); }
.feat-icon-blue   { background: rgba(99,102,241,.1);  color: #6366f1; box-shadow: 0 4px 14px rgba(99,102,241,.2); }
.feat-icon-purple { background: rgba(139,92,246,.1);  color: #7c3aed; box-shadow: 0 4px 14px rgba(139,92,246,.2); }
.feat-icon-amber  { background: rgba(245,158,11,.1);  color: #d97706; box-shadow: 0 4px 14px rgba(245,158,11,.2); }
...
@media (max-width: 900px) {
  ...
  .features-cta { padding: 36px 24px; }
}
...
.bloomy-bubble {
  ...
  display: flex; align-items: center; justify-content: center;
  cursor: pointer;
  box-shadow: 0 4px 20px rgba(20,184,166,.45);
  position: relative;
  flex-shrink: 0;
  transition: transform 0.2s;
}
.bloomy-bubble:hover { transform: scale(1.08); }
.bloomy-pulse {
  position: absolute; inset: -3px; border-radius: 50%;
  border: 2px solid rgba(20,184,166,.35);
  animation: bloomyPulse 2.5s ease-out infinite;
}
@keyframes bloomyPulse {
...
.bloomy-label {
  ...
  cursor: pointer;
  animation: bloomyLabelBounce 1s ease 1.5s both;
}
@keyframes bloomyLabelBounce {
  0%   { opacity: 0; transform: translateY(8px); }
  100% { opacity: 1; transform: translateY(0); }
}
.bloomy-label.hidden { display: none; }
...
.bloomy-card {
  ...
  animation: bloomyCardIn 0.25s ease;
}
.bloomy-card.open { display: flex; }
@keyframes bloomyCardIn {
...
.bloomy-header-left { display: flex; align-items: center; gap: 10px; }
.bloomy-avatar {
...
.bloomy-name { font-size: 0.88rem; font-weight: 700; color: #fff; }
.bloomy-status {
  font-size: 0.68rem; color: rgba(255,255,255,.8);
...
.bloomy-close:hover { background: rgba(255,255,255,.3); }

/* Messages */
.bloomy-body { padding: 16px; display: flex; flex-direction: column; gap: 10px; min-height: 80px; }
.bloomy-msg { display: flex; }
.bloomy-msg-bubble {
  background: #f1f5f9;
  border-radius: 4px 16px 16px 16px;
  padding: 10px 14px;
  font-size: 0.83rem; color: #334155; line-height: 1.5;
  max-width: 90%;
}

/* Typing indicator */
.bloomy-typing { display: flex; padding: 4px 0; }
.bloomy-typing-dots {
  background: #f1f5f9;
  border-radius: 4px 16px 16px 16px;
  padding: 10px 16px;
...
.bloomy-typing-dots span {
  width: 7px; height: 7px; border-radius: 50%;
  background: #94a3b8;
  animation: typingDot 1.2s ease-in-out infinite;
}
.bloomy-typing-dots span:nth-child(2) { animation-delay: 0.2s; }
.bloomy-typing-dots span:nth-child(3) { animation-delay: 0.4s; }
@keyframes typingDot {
...
.bloomy-cta:hover { opacity: 0.9; transform: translateY(-1px); }
...
.iph-toast svg { color: #34d399; flex-shrink: 0; }
.iph-toast.show { opacity: 1; transform: translateY(0); }
...
@media (max-width: 768px) {
  .wa-widget { bottom: 18px; right: 16px; flex-direction: column-reverse; }
  .bloomy-widget { bottom: 80px; right: 16px; }
...
/* =============================================
   ...
   ============================================= */
/* ── Demo tip bubble (Laminar Copilot style) ── */
.demo-tip {
  position: absolute;
  opacity: 0;
  pointer-events: none;
...
.demo-tip.active { opacity: 1; transform: translateX(0); }

/* Bubble floats to the right of the phone */
.demo-tip-1 { bottom: 163px; left: 197px; }
.demo-tip-2 { bottom: 186px; left: 197px; }
.demo-tip-3 { bottom: 122px; left: 197px; }
.demo-tip-4 { bottom:  26px; left: 197px; }
...
/* Large amber circle ON the phone near the element */
.demo-dot {
  position: absolute;
  width: 20px; height: 20px;
  border-radius: 50%;
...
.demo-dot.active { opacity: 1; }

/* Positioned on-screen right at the clickable element */
.demo-dot-1 { bottom: 167px; left: 171px; }   /* session row (main screen) */
.demo-dot-2 { bottom: 190px; left: 171px; }   /* textarea (form screen) */
.demo-dot-3 { bottom: 126px; left: 171px; }   /* progress select (form screen) */
.demo-dot-4 { bottom:  30px; left: 171px; }   /* submit button (form screen) */
...
.demo-dot.active { animation: demoPulse 1.4s ease-out infinite; }
